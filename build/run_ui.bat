...
REM === Пути ===
set "APPDIR=%~dp0"
set "VENV=%LOCALAPPDATA%\AnomalyDetectorStarter\ui_venv"
set "REQ=%APPDIR%ui\requirements.txt"
set "ENTRY=%APPDIR%ui\pppp.py"
set "LOG=%LOCALAPPDATA%\AnomalyDetectorStarter\ui.log"

REM ============ Обнуляем и пишем шапку лога ============
>"%LOG%" echo ===== ui Full Debug Log =====
...
popd
>>"%LOG%" echo [%DATE% %TIME%] ui завершился с кодом %EXITCODE%
